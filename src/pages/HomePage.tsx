  ...
  return (
    <>
      ...
      <main id="primary" className="site-main front-page">
        ...
        {/* 5. Interactive Ecosystem Map (the model) */}
        ...
        {/* 12. Interactive Path Finder Diagnostic Section */}
        ...
        {/* 13. The Brand Ecosystem & Platform Architecture */}
        <ScrollParallax id="brand-ecosystem" offset={40}>
          <BrandEcosystem />
        </ScrollParallax>

        {/* 14. Founder Story & Leadership Pedigree */}
        <ScrollParallax id="founder" offset={50}>
          <FounderSpotlight />
        </ScrollParallax>

        {/* 15. Continue Your Journey — Navigation Bridge */}
        <ScrollParallax offset={20}>
          <ContinueJourney />
        </ScrollParallax>

        {/* 16. Closing Community Video Banner & Direct Invitation */}
        <ScrollParallax offset={10}>
          <CommunityBanner />
        </ScrollParallax>

        {/* 17. Final brand statement */}
        <BrandStatement />
      </main>
